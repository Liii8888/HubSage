...
> Read its README and security statement, then install the reviewed v2.0.2 commit
...
`private-github-pro-review` checkout. It installs **v2.0.2**, pinned to its full
release commit:
