...
- [ ] Cut `release/v1.3.0` from `develop`.
- [ ] Promote `CHANGELOG.md#Unreleased` into a dated `v1.3.0` section.
- [ ] Merge the release branch to `main`, create an annotated tag, and publish GitHub Release notes.
